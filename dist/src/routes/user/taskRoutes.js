...
const TasksController_1 = require("../../controllers/user/TasksController");
 ...
 */
router.get('/filter', TasksController_1.TasksController.getFilteredTasks);
/**
 ...
 */
router.get('/upcoming', TasksController_1.TasksController.getUpcomingTasks);
/**
 * GET /api/tasks/stats
 ...
 */
router.get('/stats', TasksController_1.TasksController.getTaskStats);
// ==========================================
 ...
 */
router.get('/', TasksController_1.TasksController.getAll);
/**
 * GET /api/tasks/:id
 ...
 */
router.get('/:id', TasksController_1.TasksController.getById);
/**
 * POST /api/tasks
 * Create a new task
 *
 ...
 * }
 */
router.post('/', TasksController_1.TasksController.create);
/**
 * PATCH /api/tasks/:id
 ...
 * }
 */
router.patch('/:id', TasksController_1.TasksController.update);
/**
 * DELETE /api/tasks/:id
 * Delete a task
 *
 ...
 */
router.delete('/:id', TasksController_1.TasksController.delete);
